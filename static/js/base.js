...
$('.seek').focus(function () {
    ...
    if ($(this).hasClass('clickhover')) {
        ...
        $(this).find('img').attr('src', '/static/img/header/header_normal.png');

    } else {
        $(this).addClass('clickhover');
        $(this).find('.seek_content').show();
        $(this).find('img').attr('src', '/static/img/header/header_true.png');
    }
})
$('.seek_content>div').click(function () {
    ...
    $('.seek span').html(text);
    $(this).parent().hide();
    $('.seek').find('img').attr('src', '/static/img/header/header_normal.png');
    $('.seek').blur();
...
//头部hover
$(".care").hover(function () {
    $(this).attr('src', "../static/img/header/care1.png");
}, function () {
    $(this).attr('src', "../static/img/header/care.png");
});
$(".order").hover(function () {
    $(this).attr('src', "../static/img/header/order1.png");
}, function () {
    $(this).attr('src', "../static/img/header/order.png");
});
$(".shopcar").hover(function () {
    $(this).attr('src', "../static/img/header/shop_car1.png");
}, function () {
    $(this).attr('src', "../static/img/header/shop_car.png");
});
//首页按钮的渐变效果
